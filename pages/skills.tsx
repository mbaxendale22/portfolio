  ...
  return (
    <>
      ...
      <div className="h-screen font-Montserrat z-10 overflow-x-hidden relative">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-0 h-4/5 sm:px-8">
          <div className="sm:w-1/2 w-full flex flex-col justify-evenly items-center select-container">
            <div
          ...
          <div className=" w-full h-4/5 sm:h-auto sm:w-1/2">
            {display === 1 && (
              <div className="flex flex-col justify-evenly items-center h-full px-4 sm:px-8 w-full">
            ...
            {display === 2 && (
              <div className="flex flex-col justify-evenly items-center h-full px-2 sm:px-8 w-full">
            ...
            {display === 3 && (
              <div className="flex flex-col justify-evenly items-center h-full sm:px-8 w-full">
            ...
            {display === 4 && (
              <div className="flex flex-col justify-evenly items-center h-full px-8 w-full">
                ...
                <p className="text-center">
                  ...
                  technologies. For example, this portfolio was built with
