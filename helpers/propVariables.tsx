...
export const household = {
  image: '/projects/household-lp.png',
  title: 'Household',
  description:
...
export const londonParks = {
  image: '/projects/london-parks-lp.png',
  title: 'London Parks',
  description:
    "London Parks is a full stack web app, built as part of a group project. The app allows users to search for parks in London. Each park has a range of information including a weather forecast, suggested activities, a map showing the park's location, and an option to receive real-time travel information to the park. Users can review and rating for the parks, as well as curating a list of their favourite parks.",
  readme:
...
export const rickMortyVerse = {
  ...
  title: 'The Rick & Mortyverse',
  description:
    "The Rick & Mortyverse is a full stack web app deployed to the Solana blockchain. It is the result of a 48-hour hackathon hosted by Buildspace. The app acts as a repository for Rick & Morty gifs on the Solana blockchain. User's can authenticate by connecting their Phantom Wallet. After authentication, users can see gifs and post new ones. They can pay for transaction fees using their connected wallet.",
  readme:
